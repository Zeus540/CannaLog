...
const Terms = () => {
  return (
    <div>
        <Inner>
        <Heading>Terms and Conditions for CannaLog </Heading>
<h2>Introduction</h2>
...
<p>In no event shall CannaLog , nor any of its officers, directors and employees, shall be held liable for anything arising out of or in any way connected with your use of this Website whether such liability is under contract.  CannaLog , including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this Website.</p>
...
<h2>Entire Agreement</h2><p>These Terms constitute the entire agreement between CannaLog and you in relation to your use of this Website, and supersede all prior agreements and understandings.</p>
